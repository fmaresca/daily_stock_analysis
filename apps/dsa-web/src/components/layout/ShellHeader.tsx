...
const TITLES: Record<string, { title: UiTextKey; description: UiTextKey }> = {
  ...
  '/covered-calls': { title: 'layout.route.coveredCalls.title', description: 'layout.route.coveredCalls.description' },
  '/dashboard/covered-calls': { title: 'layout.route.coveredCalls.title', description: 'layout.route.coveredCalls.description' },
