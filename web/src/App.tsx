...
// Code-split heavy views & tabs with automatic deployment chunk-reload resilience
const InteractiveChart = lazyWithRetry(() => import('./components/InteractiveChart').then(m => ({ default: m.InteractiveChart })), 'InteractiveChart');
const MultiLegSpreadTable = lazyWithRetry(() => import('./components/MultiLegSpreadTable').then(m => ({ default: m.MultiLegSpreadTable })), 'MultiLegSpreadTable');
const VolatilitySkewRadar = lazyWithRetry(() => import('./components/VolatilitySkewRadar').then(m => ({ default: m.VolatilitySkewRadar })), 'VolatilitySkewRadar');
const FundamentalHealthTable = lazyWithRetry(() => import('./components/FundamentalHealthTable').then(m => ({ default: m.FundamentalHealthTable })), 'FundamentalHealthTable');
const OptionsBacktestView = lazyWithRetry(() => import('./components/OptionsBacktestView').then(m => ({ default: m.OptionsBacktestView })), 'OptionsBacktestView');
const BrokerStagingWorkbench = lazyWithRetry(() => import('./components/BrokerStagingWorkbench').then(m => ({ default: m.BrokerStagingWorkbench })), 'BrokerStagingWorkbench');
const OptionChainMatrixView = lazyWithRetry(() => import('./components/OptionChainMatrixView').then(m => ({ default: m.OptionChainMatrixView })), 'OptionChainMatrixView');
const PmccScreenerView = lazyWithRetry(() => import('./components/PmccScreenerView').then(m => ({ default: m.PmccScreenerView })), 'PmccScreenerView');
const PortfolioMarginSimulatorView = lazyWithRetry(() => import('./components/PortfolioMarginSimulatorView').then(m => ({ default: m.PortfolioMarginSimulatorView })), 'PortfolioMarginSimulatorView');
const MultiAgentTradeAuditorView = lazyWithRetry(() => import('./components/MultiAgentTradeAuditorView').then(m => ({ default: m.MultiAgentTradeAuditorView })), 'MultiAgentTradeAuditorView');
const DefensiveRollAssistantView = lazyWithRetry(() => import('./components/DefensiveRollAssistantView').then(m => ({ default: m.DefensiveRollAssistantView })), 'DefensiveRollAssistantView');
const TaxAlphaOptimizerView = lazyWithRetry(() => import('./components/TaxAlphaOptimizerView').then(m => ({ default: m.TaxAlphaOptimizerView })), 'TaxAlphaOptimizerView');
const ExecutivePortfolioDigestView = lazyWithRetry(() => import('./components/ExecutivePortfolioDigestView').then(m => ({ default: m.ExecutivePortfolioDigestView })), 'ExecutivePortfolioDigestView');
const WeeklyStockScreenersView = lazyWithRetry(() => import('./components/WeeklyStockScreenersView').then(m => ({ default: m.WeeklyStockScreenersView })), 'WeeklyStockScreenersView');
const OptionsIncomeAnalyzer = lazyWithRetry(() => import('./components/OptionsIncomeAnalyzer').then(m => ({ default: m.OptionsIncomeAnalyzer })), 'OptionsIncomeAnalyzer');
...
const MethodologyView = lazyWithRetry(() => import('./components/MethodologyView').then(m => ({ default: m.MethodologyView })), 'MethodologyView');
const FaqView = lazyWithRetry(() => import('./components/FaqView').then(m => ({ default: m.FaqView })), 'FaqView');
const DisclaimerView = lazyWithRetry(() => import('./components/DisclaimerView').then(m => ({ default: m.DisclaimerView })), 'DisclaimerView');
